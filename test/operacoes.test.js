...
describe('Suíte de Testes Fraca para 50 Operações Aritméticas', () => {
  ...
  test('4b. deve lançar a mensagem exata na divisão por zero', () => {
  ...
  test('6b. deve calcular a raiz quadrada de zero e rejeitar negativos', () => {
  ...
  test('8b. deve cobrir os casos base e o erro do fatorial', () => {
  ...
  test('9b. deve calcular a média de pares e de array vazio', () => {
  ...
  test('15b. deve retornar false para um número ímpar', () => { expect(isPar(3)).toBe(false); });
  ...
  test('17b. deve calcular uma porcentagem com valores diferentes', () => { expect(calcularPorcentagem(25, 80)).toBe(20); });
  test('18. deve aumentar um valor em uma porcentagem', () => { expect(aumentarPorcentagem(100, 10)).toBeCloseTo(110); });
  test('18b. deve aumentar um valor com outro cenário', () => {
    expect(aumentarPorcentagem(80, 25)).toBeCloseTo(100);
  });
  test('19. deve diminuir um valor em uma porcentagem', () => { expect(diminuirPorcentagem(100, 10)).toBeCloseTo(90); });
  test('19b. deve diminuir um valor com outro cenário', () => {
    expect(diminuirPorcentagem(80, 25)).toBeCloseTo(60);
  });
  test('20. deve inverter o sinal de um número positivo', () => { expect(inverterSinal(42)).toBe(-42); });
  test('20b. deve inverter o sinal de zero e de número negativo', () => {
    expect(inverterSinal(0)).toBe(-0);
    expect(inverterSinal(-8)).toBe(8);
  });
  ...
  test('33b. deve cobrir casos não primos e o menor primo', () => {
  ...
  test('34b. deve cobrir os casos base da sequência de Fibonacci', () => {
  ...
  test('36c. deve respeitar exatamente os limites do clamp', () => {
  ...
  test('38b. deve converter outro valor de Celsius para Fahrenheit', () => { expect(celsiusParaFahrenheit(10)).toBe(50); });
  test('39. deve converter Fahrenheit para Celsius', () => { expect(fahrenheitParaCelsius(212)).toBe(100); });
  test('39b. deve converter outro valor de Fahrenheit para Celsius', () => { expect(fahrenheitParaCelsius(50)).toBe(10); });
  test('40. deve calcular o inverso de um número', () => { expect(inverso(4)).toBe(0.25); });
  test('40b. deve rejeitar o inverso de zero', () => {
  ...
  test('44b. deve retornar false quando o primeiro número não é maior', () => {
  ...
  test('45b. deve retornar false quando o primeiro número não é menor', () => {
    expect(isMenorQue(10, 10)).toBe(false);
    expect(isMenorQue(12, 10)).toBe(false);
  });
  test('46. deve verificar se dois números são iguais', () => { expect(isEqual(7, 7)).toBe(true); });
  test('46b. deve distinguir igualdade de desigualdade', () => {
  ...
  test('47b. deve calcular a mediana de um array par e rejeitar vazio', () => {
    expect(medianaArray([5, 1, 3, 2])).toBe(2.5);
